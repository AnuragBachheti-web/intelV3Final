...
const NoStoresConnected = () => {
  ...
  return (
    <div className="flex flex-col items-center py-12 px-6 min-h-full">
      <div className="w-full max-w-md flex flex-col items-center text-center">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-2.5 bg-gray-900 dark:bg-slate-100 text-white dark:text-slate-900 rounded-xl text-sm font-bold hover:bg-gray-700 dark:hover:bg-slate-200 transition-all active:scale-95 shadow mb-10"
        >
