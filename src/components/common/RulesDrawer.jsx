...
const RulesDrawer = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Right-side sliding drawer (fixed width, vertical scrollbar) */}
      <div className="fixed inset-y-0 right-0 w-[440px] max-w-full bg-white dark:bg-slate-900 border-l border-gray-200 dark:border-slate-800 shadow-2xl z-[99999] flex flex-col h-full animate-in slide-in-from-right duration-300">
        
        {/* Header */}
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-100 dark:border-slate-800 flex-shrink-0">
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
                    rules.netMargin.enabled ? 'bg-emerald-600 dark:bg-emerald-500' : 'bg-gray-300 dark:bg-slate-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    rules.netMargin.enabled ? 'translate-x-6' : 'translate-x-1'
                  }`} />
                </button>
              </div>
            ...
            <div className="bg-gray-50/70 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-800 rounded-2xl p-4 space-y-3">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
                    rules.returnRate.enabled ? 'bg-emerald-600 dark:bg-emerald-500' : 'bg-gray-300 dark:bg-slate-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    rules.returnRate.enabled ? 'translate-x-6' : 'translate-x-1'
                  }`} />
                </button>
              </div>
            ...
            <div className="bg-gray-50/70 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-800 rounded-2xl p-4 space-y-3">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
                    rules.revenueShare.enabled ? 'bg-emerald-600 dark:bg-emerald-500' : 'bg-gray-300 dark:bg-slate-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    rules.revenueShare.enabled ? 'translate-x-6' : 'translate-x-1'
                  }`} />
                </button>
              </div>
            ...
            <div className="bg-gray-50/70 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-800 rounded-2xl p-4 space-y-3">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
                    rules.daysOfCover.enabled ? 'bg-emerald-600 dark:bg-emerald-500' : 'bg-gray-300 dark:bg-slate-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    rules.daysOfCover.enabled ? 'translate-x-6' : 'translate-x-1'
                  }`} />
                </button>
              </div>
