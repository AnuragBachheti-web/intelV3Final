...
import { salesWatchlistItems } from '../features/intel/sales/salesData';
...
// Looks up a watchlist entry by product name — used before falling back to a
// constructed placeholder in every "open product" handler that has one.
...
// Intel, Sales, Margin and Inventory "open product" handlers — only the
...
const useProductNavigation = () => {
  ...
  return { goToProduct, findWatchlistItem, buildFallbackWatchlistItem, buildAnalyticsKpiGroups, NO_SPECIFIC_INSIGHTS };
};
