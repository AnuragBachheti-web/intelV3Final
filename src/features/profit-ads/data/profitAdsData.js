export const PROFIT_ADS_SUMMARY = {
  ...
  categories: [
    { label: 'SCALE', value: '28', subtext: 'Upside ₹3,35,621', isActive: false },
    { label: 'FIX ADS', value: '15', subtext: 'Recoverable ₹2,03,012', isActive: true },
    { label: 'FIX MARGIN', value: '0', subtext: '0 to reprice', isActive: false },
    { label: 'CUT/DIVEST', value: '0', subtext: 'Bleed ₹0', isActive: false }
  ],
  footerProjected: '₹2,03,012'
};
...
export const MODAL_MOCK_DATA = {
  ...
  simulation: {
    ...
    targetAcos: 17,
    projections: [
      { days: '30d', gain: '+₹1,34,463', p: 'p≈0.68' },
      { days: '60d', gain: '+₹2,92,655', p: 'p≈0.62' },
      { days: '90d', gain: '+₹4,50,847', p: 'p≈0.57' }
    ],
