    ...
    >
      <div className="flex flex-col h-full relative" onClick={() => setActiveDropdown(null)}>
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 pt-0 pb-24">
          ...
          {/* Top Cards Block */}
          <div className="border border-gray-200 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 overflow-hidden shadow-sm mb-12 transition-all">
            <div className="p-6 pb-8 border-b border-gray-100 dark:border-slate-800 flex flex-col md:flex-row md:items-start justify-between gap-6">
              <div className="max-w-md">
                ...
                <div className="text-[13px] text-gray-500 dark:text-slate-400 whitespace-pre-line leading-relaxed">
                  ...
                  <br />
                  across 41 FIX ADS SKUs · <span className="font-semibold text-gray-600 dark:text-slate-300">₹3,10,259</span> certain, ₹735 rests on estimated inputs
                  <br /><br />
              ...
              <div className="px-6 pb-6 bg-[#fcfbf9] dark:bg-slate-900/50">
                <ExplanationPanel data={
                  activePanel === 'main' ? {
                    ...
                    contributors: [
                      { sku: 'SCALE0074', value: '₹4,50,000' },
                      { sku: 'SCALE0072', value: '₹3,20,000' },
                      { sku: 'SCALE0006', value: '₹1,80,000' },
                    ],
                    result: '₹16,00,190',
                    timeframe: '2026-04-01 → 2026-06-01 · 3 periods',
                    provenanceText: 'derived from per-SKU figures'
          ...
          {/* Table */}
          <div className="border border-gray-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 shadow-sm overflow-hidden mb-12">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-slate-800/50">
                {currentSkus.length === 0 ? (
                  <tr>
                    <td colSpan="5" className="py-20 text-center text-sm font-semibold text-gray-400 dark:text-slate-500">
        ...
        <div className="absolute bottom-0 left-0 w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl p-4 px-8 flex items-center justify-between shadow-[0_-4px_12px_rgba(0,0,0,0.02)] z-10">
          <p className="text-[13px] font-medium text-gray-600 dark:text-slate-400">
            {selectedCategory === 'FIX ADS' ? (
              ...
              <>Pull ACoS to break-even on all 0 For Ads SKUs in view. Projected <span className="font-bold text-emerald-600 dark:text-emerald-500">₹2,03,012</span></>
            )}
          </p>
