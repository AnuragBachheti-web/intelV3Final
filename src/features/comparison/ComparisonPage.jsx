...
import { ATTRIBUTE_CATEGORIES, ATTRIBUTES, findProductBySku } from './comparisonData';
...
const ComparisonPage = () => {
  ...
  return (
    <DashboardLayout showTabs={false}>
      ...
      {!hasProducts ? (
        /* Empty state */
        <div className="bg-white dark:bg-slate-900 border border-dashed border-gray-300 dark:border-slate-700 rounded-2xl py-16 flex flex-col items-center justify-center text-center">
