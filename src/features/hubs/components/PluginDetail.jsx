...
import { SUBSCRIPTION_META, PLUGIN_META_LINKS } from '../hubsData';
  ...
  return (
    <main className="p-4 sm:p-6 lg:px-8 lg:py-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl overflow-hidden shadow-sm">
        {/* Plugin Header */}
        <div className="p-8 border-b border-gray-100 dark:border-slate-800 flex flex-col md:flex-row gap-8 items-start">
          <div
        ...
        <div className="flex flex-col lg:flex-row">
          {/* ── Left: Main Content ── */}
          <div className="flex-1 p-8 border-r border-gray-100 dark:border-slate-800 min-w-0">
            {/* Overview */}
            ...
            {/* Reviews Section */}
            <section id="detail-reviews" className="mb-8 pt-8 border-t border-gray-100 dark:border-slate-800">
          ...
          {/* ── Right: Sidebar ── */}
          <div className="w-full lg:w-80 p-8 bg-gray-50 dark:bg-slate-800/50 flex flex-col flex-shrink-0">
            {/* Subscription Card */}
