...
import { TableCard, TD, TR, TableHead } from '../components/DenseTable';
import { campaignStatusColor } from '../detailedViewUtils';
import { campaignData, platformData } from '../detailedViewData';
import PlatformPerformanceSection from '../../intel/ads/components/PlatformPerformanceSection';

const PlatformDistributionChart = lazy(() => import('../../intel/ads/components/PlatformDistributionChart'));
