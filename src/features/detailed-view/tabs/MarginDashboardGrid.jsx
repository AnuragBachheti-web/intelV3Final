...
} from '../../intel/margin/marginData';

const MarginTrendChart = lazy(() => import('../../intel/margin/components/MarginTrendChart'));
const FeeForensics = lazy(() => import('../../intel/margin/components/FeeForensics'));
const MarginDistributionChart = lazy(() => import('../../intel/margin/components/MarginDistributionChart'));
