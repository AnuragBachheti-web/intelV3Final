    ...
    <div className="flex items-center gap-2 py-3 min-w-0">
      <div className="flex-1 grid grid-cols-5 gap-2">
        {statsData.map((stat, idx) => (
          <div key={idx} className="w-full flex items-center justify-center px-3 py-2 bg-gray-50 dark:bg-slate-800/60 border border-gray-100 dark:border-slate-700 rounded-xl">
            <div>
      ...
      <div className="hidden md:flex flex-shrink-0 items-center justify-center gap-2 self-center my-auto mt-[1.5rem]">
