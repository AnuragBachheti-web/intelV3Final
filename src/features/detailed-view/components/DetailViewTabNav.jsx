  ...
  <div className="flex items-center gap-0.5">
    {DETAIL_VIEW_TABS.map(tab => (
      <button
        ...
        className={`${compact ? 'px-3 py-1 text-[11px] gap-1' : 'px-4 py-1.5 text-sm gap-1.5'} font-medium transition-colors whitespace-nowrap flex items-center border-b-2 -mb-px ${intelType === tab.key
