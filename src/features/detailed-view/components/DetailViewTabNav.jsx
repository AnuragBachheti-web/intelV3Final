  ...
  <div className="flex items-center gap-0.5 overflow-x-auto scrollbar-hide">
    {/* {DETAIL_VIEW_TABS.map(tab => (
      <button
        ...
        className={`flex-shrink-0 ${compact ? 'px-3 py-1 text-xs gap-1' : 'px-4 py-1.5 text-base gap-1.5'} font-medium transition-colors whitespace-nowrap flex items-center border-b-2 -mb-px ${intelType === tab.key
