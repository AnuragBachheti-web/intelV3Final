...
function InviteLoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    navigate(roleLandingRoutes[invitedRole] || ROUTES.INTEL_V2_FULL);
  };
  ...
  return (
    <div className="h-screen flex font-sans overflow-hidden">
      {/* ── Left brand panel ── */}
      <div className="hidden lg:flex w-[380px] flex-shrink-0 bg-gray-900 flex-col justify-between px-10 py-12">
      ...
      {/* ── Right form panel ── */}
      <div className="flex-1 flex items-center justify-center bg-slate-50 overflow-y-auto py-10 px-4">
