...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-blue-50 via-slate-50 to-white pt-14 pb-10 border-b border-gray-100">
      ...
      <main className="flex-grow py-12 px-4">
        <div className="max-w-4xl mx-auto policy-content">
          ...
          {/* § 01 Who We Are */}
          <section id="pp-s1" className="scroll-mt-20 mb-12">
            <h2>§ 01 — Who We Are</h2>
            <p>
          ...
          <section id="pp-s2" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s3" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s4" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s5" className="scroll-mt-20 mb-12">
          ...
          {/* § 06 Sub-Processors */}
          <section id="pp-s6" className="scroll-mt-20 mb-12">
          ...
          {/* § 07 Data Security */}
          <section id="pp-s7" className="scroll-mt-20 mb-12">
          ...
          {/* § 08 Geographic Scope */}
          <section id="pp-s8" className="scroll-mt-20 mb-12">
          ...
          {/* § 09 Data Retention */}
          <section id="pp-s9" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s10" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s11" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s12" className="scroll-mt-20 mb-12">
          ...
          <section id="pp-s13" className="scroll-mt-20 mb-12">
