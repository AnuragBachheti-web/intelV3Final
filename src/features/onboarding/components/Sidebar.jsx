...
function Sidebar() {
  ...
  return (
    <>
      ...
      <div className="hidden sm:flex w-[380px] min-w-[260px] bg-white border-r border-gray-200 px-8 py-10 flex-col justify-between h-full overflow-y-auto custom-scrollbar">
        <div>
          {/* Logo */}
          <div className="mb-6">
