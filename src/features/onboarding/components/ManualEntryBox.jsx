  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        {activeTab === 'csv' ? (
          <div className="flex-1 border-2 border-dashed border-gray-200 dark:border-slate-700 rounded-2xl flex flex-col items-center justify-center p-8 text-center group hover:border-blue-500 dark:hover:border-blue-400 transition-colors">
