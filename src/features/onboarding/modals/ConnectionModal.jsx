...
function ConnectionModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
      <div className="bg-white rounded-2xl max-w-[600px] w-full p-8 shadow-2xl anim-scale-up">
        ...
        {step === 1 && (
          <div className="anim-fade-in text-center">
            ...
            <p className="text-gray-600 mb-8">We'll securely connect to your account to sync data</p>
        ...
        {step === 3 && (
          <div className="anim-fade-in">
            ...
            <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-5 mb-8 space-y-4">
              {[
        ...
        {step === 4 && (
          <div className="anim-fade-in text-center py-8">
            ...
            <p className="text-gray-600 mb-10">Please wait while we establish a secure connection</p>
        ...
        {step === 5 && (
          <div className="anim-fade-in text-center">
            ...
            <p className="text-gray-600 mb-8">Your {currentMarketplace.name} account is now syncing</p>
