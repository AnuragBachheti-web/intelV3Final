...
function SigninModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
      <div className="bg-white rounded-2xl max-w-[500px] w-full p-8 shadow-2xl anim-scale-up">
          ...
          <div className="anim-fade-in space-y-6">
            ...
            {tab === 'email' ? (
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button type="submit" className="w-full py-4 bg-brand text-white font-bold rounded-xl shadow-lg hover:bg-brand-hover transition">
        ...
        {mode === 'otp-verify' && (
          <div className="anim-fade-in text-center">
            ...
            <p className="text-gray-600 mb-8">We sent a 6-digit code to your contact</p>
