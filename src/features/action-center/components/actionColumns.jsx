...
import {
  ...
  formatImpactValue,
  getActionCta,
} from '../../intel/shared/config/actionTypeConfig';
    ...
    render: (action, ctx) => {
      ...
      return (
        <button
          ...
          className="px-3 py-1.5 text-[11.5px] font-bold text-white bg-brand hover:bg-brand-hover dark:bg-gray-600 dark:hover:bg-gray-500 rounded-lg transition active:scale-95 shadow-sm"
        >
