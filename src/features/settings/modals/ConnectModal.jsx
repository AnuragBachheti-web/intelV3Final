          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <div className="p-4 bg-gray-50 dark:bg-slate-800/50 rounded-2xl mb-8 text-left border border-gray-100 dark:border-slate-800">
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-slate-400 mb-8">{platform.name} is now successfully integrated.</p>
