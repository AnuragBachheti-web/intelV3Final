// Shared between the desktop SettingsInnerSidebar and the mobile burger-drawer
// settings sub-list, so both surfaces stay in sync with the same section list.
