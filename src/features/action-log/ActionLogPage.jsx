                        ...
                        {[
                          ...
                          <button key={tab.key} onClick={() => setFilterTab(tab.key)}
                            ...
                            <span className={`w-3.5 h-3.5 rounded-full border-2 flex-shrink-0 flex items-center justify-center ${
                              filterTab === tab.key ? 'border-gray-900 dark:border-slate-100' : 'border-gray-300 dark:border-slate-600'
                            }`}>
                            ...
                            <div className="flex flex-col gap-0.5">
                              {SORT_OPTIONS.map(opt => (
                                <button key={opt.key} onClick={() => setPendingSort(opt.key)}
                                  ...
                                  <span className={`w-3.5 h-3.5 rounded-full border-2 flex-shrink-0 flex items-center justify-center ${
                                    pendingSort === opt.key ? 'border-gray-900 dark:border-slate-100' : 'border-gray-300 dark:border-slate-600'
                                  }`}>
