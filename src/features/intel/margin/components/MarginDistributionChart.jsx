  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm h-full">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-bold text-gray-900 dark:text-slate-100">Margin Distribution</h3>
          <p className="text-sm text-gray-500 dark:text-slate-400">SKU count by margin bucket</p>
        </div>
        <div className="flex bg-gray-100 dark:bg-slate-800 p-1 rounded-lg">
          ...
          <button className="px-3 py-1 text-gray-500 dark:text-slate-400 text-xs font-bold">% of Rev</button>
        </div>
      </div>
