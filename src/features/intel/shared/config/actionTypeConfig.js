 ...
 * from the Intel signal) so rows never hardcode their own label or colour.
...
/** ₹ Lakh / Crore formatting, sign-aware. Mirrors the app's other ₹ readouts. */
export const formatImpactValue = (value) => {
