...
import { categoryBreakdown, inflowCategoryChartData } from '../cashData';
import BasePieChart from '../../../../components/common/charts/BasePieChart';

const TransactionAnalysisSection = () => {
  return (
    <section id="transaction-analysis" className="mb-8 mt-8">
