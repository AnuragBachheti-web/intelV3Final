...
import { oppDistributionData, oppFactorScoresData } from '../screenerData';
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              {oppExpandModal === 'hot-opportunity' && (
                <>
                  <div className="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/10 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-800 rounded-3xl p-8 shadow-inner">
